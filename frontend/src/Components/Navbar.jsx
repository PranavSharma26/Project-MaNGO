...
// here i have interchanges the course and aboutus
  ...
  return (
    <>
      <div
        className={`max-w-screen-2xl w-screen container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50 ${
          sticky
            ? "shadow-md bg-base-200 dark:bg-slate-600 dark:text-white duration-300 transition-all ease-in-out"
            : ""
        } ${theme === "dark" ? "dark:bg-slate-900 dark:text-white" : ""}`}
      >
