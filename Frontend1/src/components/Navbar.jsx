...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    const handleBookedResource = (data) => {
      ...
      const bookedNotificationMessage = `${ngoName} has booked a resource: ${resourceName}`;
    ...
    socket.on('resource_booked', handleBookedResource);
    ...
    return () => {
      ...
      socket.off('resource_booked', handleBookedResource);
      socket.disconnect();
    };
  }, []);
