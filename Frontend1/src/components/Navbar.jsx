...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    const handleBookedResource = (data) => {
      console.log("Resource booked data:", data); // Log the incoming data for booked resource
      
      const resourceId = data.resourceId;
      const ngoName = data.ngoName; // Assuming this contains the name of the NGO that booked the resource
      const bookedNotificationMessage = `${ngoName} has booked a resource with ID ${resourceId}`;
    
      // Prepend the new booked resource notification
      setNotifications((prevNotifications) => [bookedNotificationMessage, ...prevNotifications]);
      setHasUnread(true); // Mark notifications as unread
    };
    ...
    // Listen for booked resource event
    socket.on('booked_resource', handleBookedResource);
    ...
    return () => {
      ...
      socket.off('booked_resource', handleBookedResource);
      socket.disconnect();
    };
  }, []);
