...
function SustainabilityServices() {
    ...
    useEffect(() => {
        const fetchServices = async () => {
            try {
                const response = await fetch('http://localhost:4000/api/service/sustainability');
                if (!response.ok) {
    ...
    return (
        <div className="p-4">
            <h1 className="text-2xl font-bold mb-4">Sustainability Services</h1>
            <div className="mt-8">
